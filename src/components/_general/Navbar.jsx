...
const NavbarComp = () => {
  ...
  <div className="flex  h-[56px] sticky top-0 bg-black-rgba items-center justify-between px-10">
    ...
    {showSidebar ? (
      ...
      <div onClick={() => setShowSidebar(!showSidebar)} className="space-y-1 cursor-pointer">
      ...
      <button className="text-white bg-[#002433] w-[118px] h-[35px] rounded-[4px] text-[12px]">=>پیشرفت من</button>
    </div>

    <div className="">
      <input className="ml-3 w-[120px] text-[12px] bg-[#001D29] h-[35px] rounded-[4px]" type='text' placeholder="؟جستوجو کنید"/>
