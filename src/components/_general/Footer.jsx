        ...
        <div className=' flex mt-10 justify-between '>
          <div className='flex'>
            <div className='flex space-x-10 ml-8 '>
              <div className=''>
                <h1 className='border-b-[1px] h-[3vw] text-[12px] border-white border-opacity-30 text-white'>
                  گردش در یادش
                </h1>
                <div className='flex m-2'>
                  <div className='flex flex-col text-[10px] text-opacity-70 items-start text-white space-y-3'>
                    ...
                    <Link
                      className='bg-[#000E14] flex items-center justify-center h-[3vw] w-[7vw] rounded-md'
                      to='/'>
                      پنل کاربری
                    </Link>
                    <Link
            ...
            <div className='flex space-x-10 '>
              <div className=''>
                <h1 className='border-b-[1px] h-[3vw] text-[12px] border-white border-opacity-30 text-white ml-8'>
                  اپیزود های محبوب
                </h1>
                <div className='flex m-2'>
                  <div className='flex flex-col items-start text-[10px] text-opacity-70 text-white space-y-3'>
                    <Link
                      className=' flex items-center justify-center h-[3vw]  rounded-md'
                      to='/'>
                      اقتصاد الکترونیک
                    </Link>
                    <Link
          ...
          <div className=' w-[30vw] text-white flex flex-col justify-between mt-5'>
            ...
            <div className='flex flex-col justify-center text-[10px]'>
              ...
              <div className='flex items-center justify-between'>
                <p className='w-[19vw]'>
                  تهران خیابان انقلاب اسلامی خیابان کارگر شمالی پلاک 42 واحد 2
                </p>
                <div className='flex justify-center items-center w-10 h-10 rounded-md bg-[#001D29]'>
                  <img
                    src={"/assets/images/logos_google-maps.png"}
                    alt='maps'
                  />
                </div>
              </div>
