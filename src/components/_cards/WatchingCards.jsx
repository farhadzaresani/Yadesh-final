...
function WatchingCards() {
  return (
    <div className=' rounded-md flex flex-col w-[233px] '>
      ...
      <div className='w-[233px] h-[105px] rounded-b-md flex justify-center items-center bg-gradient-to-t from-[#002433]'>
        <button className='w-[140px] h-[40px] rounded-md bg-[#80FFC2]'>
          ادامه دهید
        </button>{" "}
      </div>
